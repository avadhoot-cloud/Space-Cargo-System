...
urlpatterns = [
    ...
    # Placement APIs
    path('placement/statistics', views.get_statistics, name='get_statistics'),
    path('placement/process', views.process_data, name='process_data'),
    path('placement/results', views.get_results, name='get_results'),
    path('placement/recommendations', views.get_recommendations, name='get_recommendations'),
    path('placement/place', views.place_item, name='place_item'),
    ...
    # Time Simulation API
    path('simulate/day', views.simulate_day, name='simulate_day'),
